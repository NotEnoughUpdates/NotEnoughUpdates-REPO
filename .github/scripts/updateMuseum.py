...
if __name__ == '__main__':
    ...
    outputJson = {
        ...
        "combat": sorted(list(itemCategories['combat']), key=lambda item: (itemToXp.get(item, 0), item)),
        "farming": sorted(list(itemCategories['farming']), key=lambda item: (itemToXp.get(item, 0), item)),
        "mining": sorted(list(itemCategories['mining']), key=lambda item: (itemToXp.get(item, 0), item)),
        "fishing": sorted(list(itemCategories['fishing']), key=lambda item: (itemToXp.get(item, 0), item)),
        "foraging": sorted(list(itemCategories['foraging']), key=lambda item: (itemToXp.get(item, 0), item)),
        "dungeoneering": sorted(list(itemCategories['dungeoneering']), key=lambda item: (itemToXp.get(item, 0), item)),
        "hunting": sorted(list(itemCategories['hunting']), key=lambda item: (itemToXp.get(item, 0), item)),
        "special": sorted(list(itemCategories['special'])),
